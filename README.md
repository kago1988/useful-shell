...
pkill 1095  # kills a process with the ProcessID (PID) 1095. The PID is printed by netstat. 
sudo lsof -i TCP:80  # pkill can kill processes by PID. lsof can kill processes by port. 
```
